...
CERTIFICATES_CSV = "/root/agent-workspace/projects/elami-dashboard/pipeline/certificates_20250101_20260825.csv"
import csv as _csv
...
INSTRUMENT_COVERED_MANUAL = {
    ...
    (1899256635, 1): 14678,    # Степанова Ирина, МОНАКО 13.08 — депозит (списание 20 000₽ 13.08) + 2×сертификат «2000₽ Бонус» (по 221.49₽ погашены 13.08) = 20 442,98₽, распределила по хронологии услуг: полностью покрывает МОНАКО (14 678₽)...
    (1899256635, 2): 5764.98,  # ...и частично Ботулинотерапию (остаток пула 5 764,98₽ из 6 664₽ — 899,02₽ так и остаются необъяснённой скидкой)
}
