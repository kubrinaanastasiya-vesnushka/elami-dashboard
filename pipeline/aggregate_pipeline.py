...
INSTRUMENT_COVERED_MANUAL = {
    ...
    (1868204406, 0): 206,      # Топыло Екатерина, Плазмотерапия/PRP 13.08 — сертификат 1000₽, сумма списания 205.71 ≈ 206 точное совпадение (её вторая позиция, Контурная пластика губ 594₽, осталась НЕ покрыта — совпадений не нашла)
